...
public class Assembler {
	...
	/**Diese Funktion liefert den Befehl am gew�nschten Index der Befehlsliste*/
	public int getOrder(int index){
		return befehlsListe.get(index);
	}
	
	/**Dieser Konstruktor erstellt eine Befehlsliste aus einem Textdokument mit dem Filename des �bergebenen Strings
